...
class Footer extends Component {
    ...
    render() {
        ...
        console.log(all,footer.product);
        console.log(all.find(ele=>ele.name===footer.product));
        
        const ul = footer.product.length && all.length?<ul className="cart-list">
            {footer.product.map(e=><li key={e}><span>{e}</span>
            <span>
                ￥{
                   all.length>0?all.find(ele=>ele.name===e).price:0
                    }
                </span> 
            ...
            <footer>
               ...
               <div className="footer-con">
                       ...
                       <div className="footer-left" onClick={this.opens}>
                           <a href="javascript:;" style={{backgroundColor:footer.product.length?'#f8c74e':'#eee'}}>
                       ...
                       <button style={{backgroundColor:footer.product.length?'#f8c74e':'#eee'}} disabled={footer.product.length?false:true}>去结算</button>
                   </div>
